...
const routes: Route[] = [
    ...
    { url: 'minha-lista',    params: { page: 'minha-lista' } },
    { url: 'outro',    params: { page: 'outro' } }
];
...
class AppRootViewModel {
    ...
    constructor(params: { history: History.History, basename: string }) {
        ...
        ko.components.register('minha-lista', require('bundle-loader?lazy!../minha-lista/minha-lista'));
        ko.components.register('outro', require('bundle-loader?lazy!../outro/outro'));
    }
